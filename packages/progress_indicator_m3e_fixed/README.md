> **Atrium's vendored fork** of upstream `progress_indicator_m3e`: do not blindly re-sync from upstream without re-applying the linear track start-offset fix (see CHANGELOG.md).
