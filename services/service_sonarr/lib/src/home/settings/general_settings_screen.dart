...
class _GeneralSettingsScreenState extends ConsumerState<GeneralSettingsScreen> {
  ...
  void _initializeValues(Map<String, dynamic> config) {
    ...
    _portController.text = (config['port'] as int? ?? 8989).toString();
    _sslPortController.text = (config['sslPort'] as int? ?? 9898).toString();
  ...
  Future<void> _save() async {
    ...
    try {
      ...
      payload['port'] = int.tryParse(_portController.text.trim()) ?? 8989;
      payload['sslPort'] = int.tryParse(_sslPortController.text.trim()) ?? 9898;
