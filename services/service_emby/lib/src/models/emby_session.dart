/// A currently-playing Emby session, built from `GET /Sessions` (the
/// `NowPlayingItem` + `PlayState` of each active client).
///
/// This is a plain view model assembled by hand in [EmbyClient.getSessions];
...
class ActiveSession {
  ...
  /// The client/device name (e.g. "Emby Web").
  final String device;
  ...
  /// The aspect ratio of the image (1.0 for square music albums, 2/3 for posters).
