...
class _EmbySessionDetailScreenState
  ...
  Widget build(BuildContext context) {
    ...
    final double pct = _isDragging ? _dragPct : (session.progressPercent / 100.0);
                ...
                children: <Widget>[
                  ...
                  Align(
                    ...
                    child: Column(
                      ...
                      children: <Widget>[
                        SizedBox(
                          height: (theme.textTheme.titleLarge?.fontSize ?? 22) * 1.5,
                        ...
                        if (session.episodeName != null) ...<Widget>[
                          ...
                          SizedBox(
                            height: (theme.textTheme.titleMedium?.fontSize ?? 16) * 1.5,
                            child: AutoScrollText(
                  ...
                  Column(
                    children: <Widget>[
                        ...
                        child: Slider(
                          ...
                          onChangeEnd: (double newValue) async {
                            ...
                            if (session.durationTicks > 0) {
                              ...
                              final EmbyClient client = await ref
                                  .read(embyClientProvider(widget.instance).future);
                      ...
                      Padding(
                        padding: const EdgeInsets.symmetric(horizontal: 24), // Align with slider track
                        child: Row(
