                  ...
                  default:
                    try {
                      ...
                      switch (value) {
                        ...
                        case 'queue_top':
                          await client.queueTop(<String>[current.hash]);
                        case 'queue_up':
                          await client.queueUp(<String>[current.hash]);
                        case 'queue_down':
                          await client.queueDown(<String>[current.hash]);
                        case 'queue_bottom':
                          await client.queueBottom(<String>[current.hash]);
                      }
