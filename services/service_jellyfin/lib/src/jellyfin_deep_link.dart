...
Future<void> launchJellyfinDeepLink(BuildContext context, JellyfinClient client, String itemId) async {
  if (Platform.isAndroid) {
    try {
      const MethodChannel channel = MethodChannel('app.atrium/launcher');
      
      // Try official mobile app
      bool launched = await channel.invokeMethod<bool>('launchPackage', <String, dynamic>{
      ...
      launched = await channel.invokeMethod<bool>('launchPackage', <String, dynamic>{
