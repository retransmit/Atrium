        ...
        data: (data) {
          ...
          return ListView.builder(
            ...
            itemBuilder: (context, index) {
              ...
              final double minSliderMax = math.max(100.0, minVal);
              final double prefSliderMax =
                  math.max(math.max(100.0, prefVal), minVal + 1.0);
              final double maxSliderMax =
                  math.max(math.max(100.0, maxVal ?? 0.0), prefVal + 1.0);
                      ...
                      Row(
                        ...
                        children: [
                          Text(
                            isUnlimited
                                ? 'Max Size: Unlimited'
                                : 'Max Size: ${maxVal.toStringAsFixed(1)} GB',
                            style: theme.textTheme.bodySmall,
                          ),
                          Row(
